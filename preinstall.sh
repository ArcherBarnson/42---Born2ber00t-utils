...
printf "		PHP\n" && \
printf "\n----------------------------------------------------------------------------------------------\n" && \
apt install php php-fpm php-mysql php-cli php-curl php-xml php-json php-zip php-mbstring php-gd php-intl php-cgi -y && \
printf "${GREEN}\n----------------------------------------------------------------------------------------------\n" && \
printf "		PHP READY\n" && \
printf "\n----------------------------------------------------------------------------------------------\n\n\n" && \
printf "${WH}\n----------------------------------------------------------------------------------------------\n" && \
...
printf "\n----------------------------------------------------------------------------------------------\n\n\n" && \
printf "${WH}\n----------------------------------------------------------------------------------------------\n" && \
printf "		INSTALLING DBUS...\n" && \
printf "\n----------------------------------------------------------------------------------------------\n" && \
apt install dbus -y && \
printf "${GREEN}\n----------------------------------------------------------------------------------------------\n" && \
printf "		DBUS PACKAGE READY\n" && \
printf "\n----------------------------------------------------------------------------------------------\n\n\n" && \
printf "${WH}\n----------------------------------------------------------------------------------------------\n" && \
